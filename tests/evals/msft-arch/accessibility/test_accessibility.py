"""tests/evals/msft-arch/accessibility/test_accessibility.py"""
...
SKILL_PATH = "msft-arch/accessibility"
...
def test_accessibility_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/msft-arch/skills/accessibility/SKILL.md"
    ).read_text()
