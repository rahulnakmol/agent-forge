"""tests/evals/msft-arch/ai-architect/test_ai_architect.py"""
...
SKILL_PATH = "msft-arch/ai-architect"
...
def test_ai_architect_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/msft-arch/skills/ai-architect/SKILL.md"
    ).read_text()
