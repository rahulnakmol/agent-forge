"""tests/evals/msft-arch/artifacts/test_artifacts.py"""
...
SKILL_PATH = "msft-arch/artifacts"
...
def test_artifacts_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/msft-arch/skills/artifacts/SKILL.md"
    ).read_text()
