"""tests/evals/msft-arch/azure-architect/test_azure_architect.py"""
...
SKILL_PATH = "msft-arch/azure-architect"
...
def test_azure_architect_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/msft-arch/skills/azure-architect/SKILL.md"
    ).read_text()
