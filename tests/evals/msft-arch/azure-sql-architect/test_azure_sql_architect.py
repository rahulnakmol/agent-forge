"""tests/evals/msft-arch/azure-sql-architect/test_azure_sql_architect.py"""
...
SKILL_PATH = "msft-arch/azure-sql-architect"
...
def test_azure_sql_architect_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/msft-arch/skills/azure-sql-architect/SKILL.md"
    ).read_text()
