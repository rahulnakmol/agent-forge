"""tests/evals/msft-arch/cicd-architect/test_cicd_architect.py"""
...
SKILL_PATH = "msft-arch/cicd-architect"
...
def test_cicd_architect_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/msft-arch/skills/cicd-architect/SKILL.md"
    ).read_text()
