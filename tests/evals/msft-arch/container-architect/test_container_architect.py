"""tests/evals/msft-arch/container-architect/test_container_architect.py"""
...
SKILL_PATH = "msft-arch/container-architect"
...
def test_container_architect_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/msft-arch/skills/container-architect/SKILL.md"
    ).read_text()
