"""tests/evals/msft-arch/d365-architect/test_d365_architect.py"""
...
SKILL_PATH = "msft-arch/d365-architect"
...
def test_d365_architect_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/msft-arch/skills/d365-architect/SKILL.md"
    ).read_text()
