"""tests/evals/msft-arch/data-architect/test_data_architect.py"""
...
SKILL_PATH = "msft-arch/data-architect"
...
def test_data_architect_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/msft-arch/skills/data-architect/SKILL.md"
    ).read_text()
