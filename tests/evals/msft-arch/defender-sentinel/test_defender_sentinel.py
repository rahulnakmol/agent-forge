"""tests/evals/msft-arch/defender-sentinel/test_defender_sentinel.py"""
...
SKILL_PATH = "msft-arch/defender-sentinel"
...
def test_defender_sentinel_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/msft-arch/skills/defender-sentinel/SKILL.md"
    ).read_text()
