"""tests/evals/msft-arch/docs/test_docs.py"""
...
def test_docs_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/msft-arch/skills/docs/SKILL.md"
    ).read_text()
