"""tests/evals/msft-arch/dotnet-architect/test_dotnet_architect.py"""
...
SKILL_PATH = "msft-arch/dotnet-architect"
...
def test_dotnet_architect_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/msft-arch/skills/dotnet-architect/SKILL.md"
    ).read_text()
