"""tests/evals/msft-arch/dotnet-modernization/test_dotnet_modernization.py"""
...
SKILL_PATH = "msft-arch/dotnet-modernization"
...
def test_dotnet_modernization_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/msft-arch/skills/dotnet-modernization/SKILL.md"
    ).read_text()
