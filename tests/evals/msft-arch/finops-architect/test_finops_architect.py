"""tests/evals/msft-arch/finops-architect/test_finops_architect.py"""
...
SKILL_PATH = "msft-arch/finops-architect"
...
def test_finops_architect_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/msft-arch/skills/finops-architect/SKILL.md"
    ).read_text()
