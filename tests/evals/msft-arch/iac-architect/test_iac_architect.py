"""tests/evals/msft-arch/iac-architect/test_iac_architect.py"""
...
SKILL_PATH = "msft-arch/iac-architect"
...
def test_iac_architect_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/msft-arch/skills/iac-architect/SKILL.md"
    ).read_text()
