"""tests/evals/msft-arch/identity-architect/test_identity_architect.py"""
...
SKILL_PATH = "msft-arch/identity-architect"
...
def test_identity_architect_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/msft-arch/skills/identity-architect/SKILL.md"
    ).read_text()
