"""tests/evals/msft-arch/m365-platform/test_m365_platform.py"""
...
SKILL_PATH = "msft-arch/m365-platform"
...
def test_m365_platform_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/msft-arch/skills/m365-platform/SKILL.md"
    ).read_text()
