"""tests/evals/msft-arch/microsoft-graph/test_microsoft_graph.py"""
...
SKILL_PATH = "msft-arch/microsoft-graph"
...
def test_microsoft_graph_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/msft-arch/skills/microsoft-graph/SKILL.md"
    ).read_text()
