"""tests/evals/msft-arch/observability-architect/test_observability_architect.py"""
...
SKILL_PATH = "msft-arch/observability-architect"
...
def test_observability_architect_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/msft-arch/skills/observability-architect/SKILL.md"
    ).read_text()
