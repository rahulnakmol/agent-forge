"""tests/evals/msft-arch/odin/test_odin.py"""
...
def test_odin_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/msft-arch/skills/odin/SKILL.md"
    ).read_text()
