"""tests/evals/msft-arch/powerplatform-architect/test_powerplatform_architect.py"""
...
SKILL_PATH = "msft-arch/powerplatform-architect"
...
def test_powerplatform_architect_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/msft-arch/skills/powerplatform-architect/SKILL.md"
    ).read_text()
