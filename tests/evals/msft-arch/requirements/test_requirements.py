"""tests/evals/msft-arch/requirements/test_requirements.py"""
...
SKILL_PATH = "msft-arch/requirements"
...
def test_requirements_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/msft-arch/skills/requirements/SKILL.md"
    ).read_text()
