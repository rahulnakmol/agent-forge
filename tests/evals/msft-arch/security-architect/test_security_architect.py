"""tests/evals/msft-arch/security-architect/test_security_architect.py"""
...
SKILL_PATH = "msft-arch/security-architect"
...
def test_security_architect_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/msft-arch/skills/security-architect/SKILL.md"
    ).read_text()
