"""tests/evals/msft-arch/spec/test_spec.py"""
...
def test_spec_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/msft-arch/skills/spec/SKILL.md"
    ).read_text()
