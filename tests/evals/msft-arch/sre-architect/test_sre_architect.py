"""tests/evals/msft-arch/sre-architect/test_sre_architect.py"""
...
SKILL_PATH = "msft-arch/sre-architect"
...
def test_sre_architect_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/msft-arch/skills/sre-architect/SKILL.md"
    ).read_text()
