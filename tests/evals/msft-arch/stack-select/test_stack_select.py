"""tests/evals/msft-arch/stack-select/test_stack_select.py"""
...
SKILL_PATH = "msft-arch/stack-select"
...
def test_stack_select_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/msft-arch/skills/stack-select/SKILL.md"
    ).read_text()
