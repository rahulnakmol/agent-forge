"""tests/evals/msft-arch/standards/test_standards.py"""
...
SKILL_PATH = "msft-arch/standards"
...
def test_standards_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/msft-arch/skills/standards/SKILL.md"
    ).read_text()
