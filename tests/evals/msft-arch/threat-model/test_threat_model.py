"""tests/evals/msft-arch/threat-model/test_threat_model.py"""
...
SKILL_PATH = "msft-arch/threat-model"
...
def test_threat_model_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/msft-arch/skills/threat-model/SKILL.md"
    ).read_text()
