"""tests/evals/msft-arch/validate/test_validate.py"""
...
def test_validate_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/msft-arch/skills/validate/SKILL.md"
    ).read_text()
