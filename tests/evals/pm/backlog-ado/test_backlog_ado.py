"""tests/evals/pm/backlog-ado/test_backlog_ado.py"""
...
def test_backlog_ado_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/pm/skills/backlog-ado/SKILL.md"
    ).read_text()
