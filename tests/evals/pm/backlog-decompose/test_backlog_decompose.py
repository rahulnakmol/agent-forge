"""tests/evals/pm/backlog-decompose/test_backlog_decompose.py"""
...
SKILL_PATH = "pm/backlog-decompose"
...
def test_backlog_decompose_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/pm/skills/backlog-decompose/SKILL.md"
    ).read_text()
