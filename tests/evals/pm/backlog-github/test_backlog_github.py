"""tests/evals/pm/backlog-github/test_backlog_github.py"""
...
def test_backlog_github_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/pm/skills/backlog-github/SKILL.md"
    ).read_text()
