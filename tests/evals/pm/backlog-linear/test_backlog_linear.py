"""tests/evals/pm/backlog-linear/test_backlog_linear.py"""
...
def test_backlog_linear_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/pm/skills/backlog-linear/SKILL.md"
    ).read_text()
