"""tests/evals/pm/philosophy/test_philosophy.py"""
...
def test_philosophy_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/pm/skills/philosophy/SKILL.md"
    ).read_text()
