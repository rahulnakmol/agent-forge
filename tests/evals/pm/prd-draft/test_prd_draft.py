"""tests/evals/pm/prd-draft/test_prd_draft.py"""
...
def test_prd_draft_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/pm/skills/prd-draft/SKILL.md"
    ).read_text()
