"""tests/evals/pm/prd-review/test_prd_review.py"""
...
def test_prd_review_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/pm/skills/prd-review/SKILL.md"
    ).read_text()
