"""tests/evals/pm/prd-validate/test_prd_validate.py"""
...
def test_prd_validate_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/pm/skills/prd-validate/SKILL.md"
    ).read_text()
