"""tests/evals/prompts/prompt-forge/test_prompt_forge.py"""
...
SKILL_PATH = "prompts/prompt-forge"
...
def test_prompt_forge_quality(case, update_baselines) -> None:
    ...
    skill_body = (
        HERE.parents[3] / "plugins/prompts/skills/prompt-forge/SKILL.md"
    ).read_text()
